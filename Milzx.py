...
def moch_milzx():
    time.sleep(0.1)
    print(" \033[97m [\033[90m01\033[97m] Start  Cr4ck ID ")
    print(" \033[97m [\033[98m02\033[97m] Tutor  How to Get Fb Cookies ")
    print(" \033[97m [\033[97m03\033[97m] Joined Grup Fb  《COMUNITY》OF THE HACKER♡")
    print(" \033[97m [\033[95m04\033[97m] Joined Grup Fb ZtRun ")
    print(" \033[97m [\033[94m05\033[97m] Update Tools ")
